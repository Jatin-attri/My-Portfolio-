    ...
    <section id="education" className="scroll-mt-32 relative">
      ...
      >
        <motion.div
          ...
          className="absolute -top-4 right-10 h-24 w-24 rounded-full bg-cyan-500/10 blur-2xl"
        />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {education.map((edu, index) => {
              ...
              <motion.div
                ...
                className="group relative p-6 rounded-2xl glass-card hover:border-cyan-300/35 hover:shadow-[0_18px_40px_-20px_rgba(34,211,238,0.44)] transition-all duration-300 overflow-hidden"
              >
                <div
                ...
                <motion.div
                  ...
                  className="relative z-10 w-11 h-11 rounded-xl bg-cyan-500/20 border border-cyan-300/30 flex items-center justify-center text-cyan-200 mb-4"
                >
                ...
                <div className="relative z-10 inline-flex items-center rounded-full border border-white/10 bg-white/[0.04] px-3 py-1 text-[11px] font-semibold text-cyan-100 uppercase tracking-wider">
                  {edu.dates}
                </div>
              </motion.div>
            );
          ...
          <div className="flex flex-wrap gap-4">
            {certifications.map((cert, index) => (
              <motion.div
                ...
                className="group relative flex items-center gap-3 px-5 py-3 rounded-xl bg-gradient-to-r from-white/[0.07] to-white/[0.03] border border-white/10 hover:border-cyan-300/35 hover:bg-cyan-500/10 hover:shadow-[0_0_22px_rgba(34,211,238,0.24)] transition-all duration-300 overflow-hidden"
              >
                <motion.div
                  aria-hidden
                  initial={{ x: "-130%" }}
                ...
                />
                <Award size={18} className="relative z-10 text-cyan-300" />
